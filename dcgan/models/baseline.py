...
def make_generator_model():
    ...
    model.add(layers.Dense(7*7*256, use_bias=False, input_shape=(noise_dim,)))  # Updated input_shape
...
def train_step(images):
    noise = tf.random.normal([BATCH_SIZE, noise_dim])  # Updated BATCH_SIZE
