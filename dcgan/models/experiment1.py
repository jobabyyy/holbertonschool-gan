...
def generator_variation():
    generator = keras.Sequential(
        ...
        name="generator_variation",
    )
    print("Modified Generator created with layers:")
...
generator = generator_variation()
discriminator = discriminator_variation()
